...
public class PrinterHelper
{
    ...
    public static void showMainMenu(){
        ...
        System.out.println( "| . 7 Avg Grade Of A Course     |" );
        ...
        throws ParseException
    {
        ...
        while(true) {
            try {
                ...
                System.out.println("Date value or format is invalid. Please Enter again");
            }
        }
    }

//    public static void printStudentSummaryHeader() {
//        System.out.println( "|-------------------------------|" );
