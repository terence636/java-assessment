...
public class CourseService
{
    ...
    // No specific requirement to approve which course for
    // student. Hence, all courses are approved
    public void approveCourseForStudent(Student student) {
        for(Course course: courses.values()) {
            student.registerApprovedCourse(course);
        }
    }

    public List<Student> getEnrolledStudentList(String courseId) {
